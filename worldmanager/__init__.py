import os.path
# 导入DialogEventGenerator类，用于生成对话事件  
from tools.generator import DialogEventGenerator
# 导入create_folder, create_txt, create_txt_no_content, CharacterInfo函数，用于创建文件夹、创建文本文件和创建没有内容的文本文件
from tools.utils import create_folder, create_txt, create_txt_no_content, CharacterInfo
# 导入PROMPT_TEMPLATE, IDENTITY_TEMPLATE变量，用于生成提示词和身份信息
